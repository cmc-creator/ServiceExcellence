...
const defaultRoleConfigs = [
  {
    ...
    enabledModules: [
      "controlled-substance-diversion-audit",
      "involuntary-hold-court-order-workflow",
      "visitor-boundary-de-escalation",
      "discharge-safety-plan-followup-closure",
      "social-media-boundary-confidentiality",
    ],
  },
  {
...
const bonusScenario = {
  title: "Secret Bonus: Diversion Alert During Complex Discharge",
  category: "Challenge - Diversion, Legal Hold, and Confidentiality",
  roles: ["clinical", "nonclinical", "leadership"],
  prompt: "A controlled-substance count mismatch appears before discharge, legal hold paperwork is incomplete, and a staff member posts about the case online. Best first sequence?",
  choices: [
    { text: "Secure medication inventory and escalate diversion protocol, verify legal hold and court documentation before release, and trigger confidentiality response with immediate reporting.", score: 20, good: true, feedback: "Excellent. This sequence protects medication safety, legal compliance, and confidentiality integrity." },
    { text: "Prioritize discharge timing only and defer diversion/legal concerns until later.", score: 8, good: false, feedback: "Deferring diversion or legal-hold concerns increases immediate patient and regulatory risk." },
    { text: "Continue discharge flow and ask team to keep concerns informal.", score: 2, good: false, feedback: "Informal handling undermines controlled-substance security, legal compliance, and privacy." },
  ],
};
...
const roleDepartmentSpotlights = {
  clinical: [
    {
      title: "Outbreak Cohorting Example",
      points: [
        "Escalate symptom clusters immediately and separate exposed/intake pathways.",
        "Document cohort assignment rationale and PPE workflow at handoff.",
      ],
    },
    {
      title: "Patient Rights and Grievance Example",
      points: [
        "Explain grievance channels clearly and document patient-rights concerns objectively.",
        "Escalate unresolved rights concerns to ombuds process without delay.",
      ],
    },
    {
      title: "Telehealth Privacy Example",
      points: [
        "Use private space, identity verification, and minimum-necessary data sharing.",
        "Terminate or reset sessions when unauthorized listeners are present.",
      ],
    },
    {
      title: "Emergency Transfer Handoff Example",
      points: [
        "Use SBAR plus risk alerts, medication status, and legal hold details.",
        "Confirm receiver read-back before transport departure.",
      ],
    },
    {
      title: "Harassment and Retaliation Safeguards Example",
      points: [
        "Report harassment through protected channels immediately.",
        "Escalate retaliation indicators and preserve objective timeline evidence.",
      ],
    },
  ],
  nonclinical: [
    {
      title: "Frontline Cohorting Support Example",
      points: [
        "Route symptomatic arrivals through designated intake flow immediately.",
        "Notify clinical lead of exposure concerns using exact time/location details.",
      ],
    },
    {
      title: "Rights Intake Example",
      points: [
        "Capture grievance details neutrally and provide ombuds contact options.",
        "Never discourage or delay formal grievance submission.",
      ],
    },
    {
      title: "Telehealth Access Control Example",
      points: [
        "Verify participant identity before joining remote sessions.",
        "Escalate privacy interruptions or recording concerns immediately.",
      ],
    },
    {
      title: "Transfer Coordination Support",
      points: [
        "Confirm required packet elements are complete before dispatch.",
        "Log sender/receiver confirmation timestamps for continuity.",
      ],
    },
    {
      title: "Respectful Workplace Support",
      points: [
        "Escalate harassment disclosures through protected reporting paths.",
        "Do not reassign complainants punitively or signal retaliation risk.",
      ],
    },
  ],
  leadership: [
    {
      ...
      points: [
        "Audit exposure response times, cohort integrity, and PPE adherence trends.",
        "Coordinate staffing contingency plans when isolation census changes rapidly.",
      ],
    },
    {
      title: "Rights and Ombuds Governance",
      points: [
        "Track grievance closure quality, response time, and communication completeness.",
        "Escalate repeated rights complaints into corrective action plans.",
      ],
    },
    {
      title: "Telehealth Privacy Governance",
      points: [
        "Monitor remote-session privacy incidents and mitigation completion.",
        "Enforce identity verification and no-recording controls.",
      ],
    },
    {
      title: "Transfer Reliability Governance",
      points: [
        "Review handoff completeness and transport delay root causes.",
        "Require SBAR compliance with read-back evidence.",
      ],
    },
    {
      title: "Anti-Retaliation Governance",
      points: [
        "Investigate retaliation allegations promptly with protected reporting safeguards.",
        "Measure closure quality and coaching outcomes for respectful workplace standards.",
      ],
    },
  ],
};
...
const TRAINING_CATEGORIES = {
  communication: {
    label: "Discharge and Follow-Up Communication",
    retryModule: "Revisit discharge-handoff and follow-up closure modules to strengthen closed-loop continuity.",
  },
  conduct: {
    label: "Confidentiality and Professional Boundaries",
    retryModule: "Review social-media and confidentiality scenarios for reporting and professionalism standards.",
  },
  privacy: {
    label: "Controlled Substance and Documentation Integrity",
    retryModule: "Repeat diversion-prevention modules focused on reconciliation checks and objective documentation.",
  },
  reporting: {
    label: "Legal Hold and Court Order Escalation",
    retryModule: "Re-run legal-hold and court-order scenarios to reinforce escalation routing and objective documentation.",
  },
  safety: {
    label: "Visitor Safety and De-Escalation",
    retryModule: "Revisit visitor-boundary and de-escalation modules to improve immediate safety decisions.",
  },
  abuseNeglect: {
    label: "Diversion and Confidentiality Critical Escalation",
    retryModule: "Repeat high-risk diversion and confidentiality scenarios to strengthen protected reporting and urgent action.",
  },
  knowledgeCheck: {
...
function buildNextStepGuidance(pass, assessmentPct, recommendations) {
  ...
  if (pass && recommendations.length === 0) {
    return `${roleName}: strong completion. ${abuseNeglectClause} Next step is a monthly refresh focused on diversion-audit readiness, legal handoff accuracy, and confidentiality discipline.`;
  }
  if (pass && recommendations.length > 0) {
  ...
  return `${roleName}: assessment at ${assessmentPct}%. ${abuseNeglectClause} Complete recommended retry modules, then reattempt the full assessment with focus on immediate escalation, legal compliance, and confidentiality protection.`;
}

const coreLessons = [
  {
    moduleId: "controlled-substance-diversion-audit",
    spotlightIndex: 0,
    title: "Lesson 1: Controlled Substance Diversion Alerts and Reconciliation",
    ...
    answers: [
      { text: "Secure inventory, initiate diversion protocol, complete witnessed recount, and escalate to supervisor/pharmacy now.", good: true, score: 8 },
      { text: "Finish med pass first and recount later.", good: false, score: 2 },
      { text: "Adjust count to expected level and monitor next shift.", good: false, score: 1 },
    ],
    why: "Immediate diversion escalation protects patients and controlled-substance integrity.",
    categoryKey: "safety",
    recap: "Checkpoint: diversion prevention requires rapid escalation, witnessed reconciliation, and objective documentation.",
  },
  {
    moduleId: "involuntary-hold-court-order-workflow",
    spotlightIndex: 1,
    title: "Lesson 2: Involuntary Hold and Court Order Documentation Workflow",
    ...
    answers: [
      { text: "Pause transfer, reconcile legal order with read-back, and document final hold status before movement.", good: true, score: 8 },
      { text: "Proceed and let receiving unit clarify later.", good: false, score: 2 },
      { text: "Use prior admission hold status by default.", good: false, score: 1 },
    ],
    why: "Legal ambiguity must be resolved before any transfer or disposition decision.",
    categoryKey: "communication",
    recap: "Checkpoint: legal-hold workflow requires verified status and closed-loop documentation.",
  },
  {
    moduleId: "visitor-boundary-de-escalation",
    spotlightIndex: 2,
    title: "Lesson 3: Visitor Boundary Management and De-Escalation",
    ...
    answers: [
      { text: "Apply de-escalation language, enforce boundary protocol, and summon support/security per policy.", good: true, score: 8 },
      { text: "Ignore and hope behavior settles.", good: false, score: 2 },
      { text: "Argue loudly to establish authority.", good: false, score: 1 },
    ],
    why: "Early de-escalation and boundary enforcement reduce immediate safety risk.",
    categoryKey: "privacy",
    recap: "Checkpoint: visitor boundary control requires calm de-escalation and timely escalation support.",
  },
  {
    moduleId: "discharge-safety-plan-followup-closure",
    spotlightIndex: 3,
    title: "Lesson 4: Discharge Safety Plan and 72-Hour Follow-Up Closure",
    ...
    answers: [
      { text: "Pause discharge, complete safety-plan and follow-up confirmation, then proceed with documented handoff.", good: true, score: 8 },
      { text: "Discharge now and schedule follow-up later if possible.", good: false, score: 2 },
      { text: "Provide generic instructions without closed-loop verification.", good: false, score: 1 },
    ],
    why: "Discharge safety requires verified continuity steps before release.",
    categoryKey: "reporting",
    recap: "Checkpoint: discharge reliability requires verified safety planning and follow-up closure.",
  },
  {
    moduleId: "social-media-boundary-confidentiality",
    spotlightIndex: 4,
    title: "Lesson 5: Social Media Boundaries and Patient Confidentiality",
    ...
    answers: [
      { text: "Escalate confidentiality incident immediately, preserve evidence, and begin corrective process per policy.", good: true, score: 8 },
      { text: "Ask for quick deletion and move on.", good: false, score: 2 },
      { text: "Ignore unless a complaint is filed.", good: false, score: 1 },
    ],
    why: "Rapid escalation limits downstream privacy harm and compliance exposure.",
    categoryKey: "conduct",
    recap: "Checkpoint: social-media boundaries require immediate response and documented corrective action.",
  },
];

const scenarios = [
  {
    title: "Scenario 1: Controlled Substance Count Mismatch",
    category: "Diversion Prevention - Immediate Escalation",
    roles: ["clinical", "nonclinical", "leadership"],
  ...
  {
    title: "Scenario 2: PRN Cart Access Anomaly",
    category: "Diversion Prevention - Access Control",
  ...
  {
    title: "Scenario 3: Incomplete Legal Hold Packet",
    category: "Legal Hold - Handoff Reliability",
    roles: ["clinical", "nonclinical", "leadership"],
  ...
  {
    title: "Scenario 4: Court Order Clarification Delay",
    category: "Court Order - Frontline Escalation",
  ...
  {
    title: "Scenario 5: Visitor Escalation in Treatment Area",
    category: "Visitor Management - Immediate De-Escalation",
    roles: ["clinical", "leadership"],
  ...
  {
    title: "Scenario 6: Visitor Recording and Boundary Breach",
    category: "Visitor Management - Privacy and Boundary Risk",
    roles: ["clinical", "nonclinical", "leadership"],
  ...
  {
    title: "Scenario 7: Discharge Safety Plan Gaps",
    category: "Discharge Planning - Safety First",
    roles: ["clinical", "nonclinical", "leadership"],
  ...
  {
    title: "Scenario 8: 72-Hour Follow-Up Failure Risk",
    category: "Follow-Up Closure - Monitoring Compliance",
    roles: ["leadership"],
  ...
  {
    title: "Scenario 9: Staff Social Post About Active Case",
    category: "Confidentiality - Social Media Boundaries",
    roles: ["clinical", "nonclinical", "leadership"],
  ...
  {
    title: "Scenario 10: Confidentiality Breach Escalation",
    category: "Confidentiality - Escalation and Corrective Action",
    roles: ["clinical", "leadership"],
