...
const defaultRoleConfigs = [
  {
    ...
    enabledModules: [
      "elopement-prevention-search",
      "suicide-observation-handoffs",
      "high-alert-med-reconciliation",
      "restraint-seclusion-alternatives",
...
const bonusScenario = {
  title: "Secret Bonus: Missing Patient, Mixed Signals",
  category: "Challenge - Elopement, Observation, and Equity",
  roles: ["clinical", "nonclinical", "leadership"],
  prompt: "A high-risk patient is unaccounted for during shift change, last observation note conflicts with hallway report, and family requests updates in another language. Best first sequence?",
  choices: [
    { text: "Start elopement search protocol immediately, reconcile observation status with read-back, and use qualified interpreter support for family communication.", score: 20, good: true, feedback: "Excellent. This sequence protects safety, communication integrity, and equity." },
    { text: "Wait 15 minutes for possible return, then review notes later.", score: 8, good: false, feedback: "Search and reconciliation delays increase patient-safety risk." },
    { text: "Give family partial update in English only and continue rounds.", score: 2, good: false, feedback: "Unqualified communication can compromise care and trust." },
  ],
};
...
const roleDepartmentSpotlights = {
  clinical: [
    {
      title: "Elopement Prevention Example",
      points: [
        "Confirm unit exits, risk cues, and observation assignment at every handoff.",
        "Trigger search/escalation workflow immediately when location uncertainty appears.",
      ],
    },
    {
      title: "Suicide Observation Handoff Example",
      points: [
        "Use direct self-harm reassessment language and document findings verbatim.",
        "Perform read-back on observation level and special precautions.",
      ],
    },
    {
      title: "High-Alert Medication Reconciliation Example",
      points: [
        "Pause administration on reconciliation conflicts and verify against current status/allergies.",
        "Escalate high-alert discrepancies to prescriber/pharmacy immediately.",
      ],
    },
    {
      title: "Restraint/Seclusion Standards Example",
      points: [
        "Use least-restrictive interventions first and document alternatives attempted.",
        "Ensure time-limited orders, monitoring cadence, and release criteria are explicit.",
      ],
    },
    {
      title: "Cultural Competence Example",
      points: [
        "Use qualified interpreters for consent/safety conversations.",
        "Check understanding with teach-back in culturally respectful language.",
      ],
    },
  ],
  nonclinical: [
    {
      title: "Frontline Elopement Alert Example",
      points: [
        "Escalate immediately when a high-risk patient is missing expected location.",
        "Capture last-seen details for rapid team search coordination.",
      ],
    },
    {
      title: "Observation Communication Example",
      points: [
        "Route urgent self-harm concerns instantly to clinical lead.",
        "Avoid minimizing language when reporting risk cues.",
      ],
    },
    {
      title: "Medication Routing Example",
      points: [
        "Forward high-alert med concerns with exact identifiers and timing.",
        "Never infer dosing or reconciliation outcomes in administrative notes.",
      ],
    },
    {
      title: "Restraint Event Documentation Support",
      points: [
        "Record timestamps and notifications accurately for monitoring checks.",
        "Escalate missing order/monitoring documentation immediately.",
      ],
    },
    {
      title: "Interpreter Access Example",
      points: [
        "Arrange qualified interpreter services for critical communication moments.",
        "Avoid using minors or untrained family members as interpreters.",
      ],
    },
  ],
  leadership: [
    {
      title: "Elopement Governance Example",
      points: [
        "Audit elopement near misses, response time, and door-control reliability.",
        "Coach proactive risk escalation at shift transitions.",
      ],
    },
    {
      title: "Observation Reliability Governance",
      points: [
        "Track observation-level handoff consistency and reassessment completion.",
        "Debrief misses using policy-first corrective coaching.",
      ],
    },
    {
      title: "Medication Safety Governance",
      points: [
        "Monitor high-alert reconciliation delays and override patterns.",
        "Require closure documentation for all flagged discrepancies.",
      ],
    },
    {
      title: "Least-Restrictive Care Governance",
      points: [
        "Review restraint/seclusion use rates and alternative intervention evidence.",
        "Escalate monitoring or order-timing failures as safety events.",
      ],
    },
    {
      title: "Equitable Communication Governance",
      points: [
        "Track interpreter-use compliance for high-risk conversations.",
        "Ensure culturally responsive communication standards are coached and audited.",
      ],
    },
  ],
};
...
const TRAINING_CATEGORIES = {
  communication: {
    label: "Suicide Reassessment and Communication",
    retryModule: "Revisit reassessment/handoff modules to reinforce direct-risk language and read-back reliability.",
  },
  conduct: {
    label: "Cultural Competence and Professional Conduct",
    retryModule: "Review interpreter-use and culturally responsive communication scenarios for policy alignment.",
  },
  privacy: {
    label: "Medication and Record Accuracy",
    retryModule: "Repeat high-alert reconciliation modules focused on verification and objective documentation.",
  },
  reporting: {
    label: "Elopement and Incident Escalation",
    retryModule: "Re-run elopement and incident scenarios to strengthen immediate escalation and closure follow-through.",
  },
  safety: {
    label: "Observation and Least-Restrictive Safety",
    retryModule: "Revisit observation and restraint-alternative modules to reinforce first-action safety sequencing.",
  },
  abuseNeglect: {
...
function buildNextStepGuidance(pass, assessmentPct, recommendations) {
  ...
  if (pass && recommendations.length === 0) {
    return `${roleName}: strong completion. ${abuseNeglectClause} Next step is a quarterly 10-minute refresh focused on elopement readiness, observation handoff reliability, and reconciliation discipline.`;
  }
  if (pass && recommendations.length > 0) {
...
const coreLessons = [
  {
    moduleId: "elopement-prevention-search",
    spotlightIndex: 0,
    title: "Lesson 1: Patient Elopement Prevention and Search Protocols",
    body: "Elopement prevention depends on risk identification, environmental controls, and immediate search escalation when location is uncertain. Minutes matter for patient safety.",
    check: "A high-risk patient is not in assigned area during rounding. Strongest immediate action?",
    answers: [
      { text: "Activate elopement search protocol now, report last-seen details, and assign zone sweep responsibilities.", good: true, score: 8 },
      { text: "Wait 10 minutes in case patient self-returns.", good: false, score: 2 },
      { text: "Check only nearby rooms and update later.", good: false, score: 1 },
    ],
    why: "Immediate coordinated search escalation reduces harm risk.",
    categoryKey: "safety",
    recap: "Checkpoint: elopement prevention requires rapid escalation, shared situational awareness, and documentation.",
  },
  {
    moduleId: "suicide-observation-handoffs",
    spotlightIndex: 1,
    title: "Lesson 2: Suicide Reassessment and Observation Handoffs",
    body: "Suicide-risk management requires direct reassessment language, reliable observation assignment, and closed-loop handoff communication.",
    check: "At shift change, chart says Q15 checks but bedside report says constant observation. Best response?",
    answers: [
      { text: "Pause handoff, reconcile order immediately with read-back, and document final observation level.", good: true, score: 8 },
      { text: "Default to Q15 until day team clarifies.", good: false, score: 2 },
      { text: "Let receiving unit decide after transfer.", good: false, score: 1 },
    ],
    why: "Observation ambiguity must be resolved before care transfer.",
    categoryKey: "communication",
    recap: "Checkpoint: direct reassessment and closed-loop handoff prevent high-risk gaps.",
  },
  {
    moduleId: "high-alert-med-reconciliation",
    spotlightIndex: 2,
    title: "Lesson 3: High-Alert Medication Reconciliation",
    body: "Medication reconciliation requires identifier verification, allergy/interaction checks, and immediate escalation of high-alert discrepancies.",
    check: "A high-alert med appears duplicated across transfer orders with conflicting doses. Best first step?",
    answers: [
      { text: "Hold administration, verify source records, and escalate reconciliation to prescriber/pharmacy immediately.", good: true, score: 8 },
      { text: "Give lower dose now and clarify later.", good: false, score: 2 },
      { text: "Use previous admission dose by habit.", good: false, score: 1 },
    ],
    why: "High-alert discrepancies require stop-verify-escalate workflow.",
    categoryKey: "privacy",
    recap: "Checkpoint: reconciliation reliability prevents preventable adverse medication events.",
  },
  {
    moduleId: "restraint-seclusion-alternatives",
    spotlightIndex: 3,
    title: "Lesson 4: Restraint/Seclusion Standards and Least-Restrictive Alternatives",
    body: "Restrictive interventions require policy thresholds, documented alternatives, time-limited orders, and active monitoring to protect rights and safety.",
    check: "Behavior escalates quickly; team considers restraint before attempting alternatives. Best response?",
    answers: [
      { text: "Initiate least-restrictive interventions first, document attempts, and escalate to restraint only if criteria are met.", good: true, score: 8 },
      { text: "Apply restraint immediately to regain control, document later.", good: false, score: 2 },
      { text: "Wait for behavior to worsen before any intervention.", good: false, score: 1 },
    ],
    why: "Least-restrictive care plus clear documentation protects patient rights.",
    categoryKey: "reporting",
    recap: "Checkpoint: restraint decisions require criteria-based escalation and monitoring fidelity.",
  },
  {
    moduleId: "cultural-competence-interpretation",
    spotlightIndex: 4,
    title: "Lesson 5: Cultural Competence and Interpreter Use",
    body: "Culturally responsive care requires interpreter access, bias awareness, and confirmation of understanding for high-risk decisions.",
    check: "Family offers to translate consent discussion for a patient with limited English proficiency. Best response?",
    answers: [
      { text: "Use a qualified interpreter and verify understanding with teach-back before consent decisions.", good: true, score: 8 },
      { text: "Accept family interpretation for speed.", good: false, score: 2 },
      { text: "Proceed in English and assume understanding.", good: false, score: 1 },
    ],
    why: "Qualified interpretation safeguards informed decisions and equity.",
    categoryKey: "conduct",
    recap: "Checkpoint: equitable communication requires interpreter fidelity and understanding checks.",
  },
];

const scenarios = [
  {
    title: "Scenario 1: Missing High-Risk Patient",
    category: "Elopement Prevention - Immediate Search",
    roles: ["clinical", "nonclinical", "leadership"],
    prompt: "A high-risk patient is not in assigned room during safety check. Best immediate response?",
    choices: [
      { text: "Activate elopement protocol now, share last-seen details, and assign search zones with leadership notification.", score: 16, good: true, feedback: "Correct. Immediate coordinated search is required." },
      { text: "Wait briefly in case patient returns independently.", score: 6, good: false, feedback: "Delay increases risk and expands search complexity." },
      { text: "Document concern first and start search at shift end.", score: 2, good: false, feedback: "Search must begin immediately, not after documentation delay." },
    ],
    categoryKey: "reporting",
    recap: "Scenario recap: elopement response requires immediate escalation and coordinated zone search.",
  },
  {
    title: "Scenario 2: Exit Door Tailgating Risk",
    category: "Elopement Prevention - Environmental Control",
    ...
    choices: [
      { text: "Stop unsafe access behavior now, reinforce controls, and document corrective action with follow-up audit.", score: 18, good: true, feedback: "Correct. Environmental controls are part of elopement prevention." },
      { text: "Allow temporary exception because staff are busy.", score: 5, good: false, feedback: "Convenience exceptions can create immediate risk." },
      { text: "Postpone correction until monthly meeting.", score: 4, good: false, feedback: "Delay leaves known vulnerability unmitigated." },
    ],
    categoryKey: "reporting",
    recap: "Scenario recap: access-control drift should be corrected and documented immediately.",
  },
  {
    title: "Scenario 3: Conflicting Observation Orders",
    category: "Suicide Observation - Handoff Reliability",
    roles: ["clinical", "nonclinical", "leadership"],
    prompt: "Two notes list different observation levels after a self-harm statement. Best response?",
    choices: [
      { text: "Reassess risk now, reconcile order with read-back, and document final level before transfer.", score: 18, good: true, feedback: "Correct. Observation discrepancies must be resolved immediately." },
      { text: "Default to lower level and recheck at rounds.", score: 6, good: false, feedback: "Downgrading without reconciliation increases risk." },
      { text: "Leave conflict for receiving unit to manage.", score: 3, good: false, feedback: "Unresolved handoff ambiguity is unsafe." },
    ],
    categoryKey: "communication",
    recap: "Scenario recap: suicide-risk handoffs require direct reassessment and closed-loop clarity.",
  },
  {
    title: "Scenario 4: Indirect Self-Harm Cue",
    category: "Suicide Observation - Frontline Escalation",
    ...
    choices: [
      { text: "Escalate immediately to clinical risk pathway and communicate exact statement verbatim.", score: 18, good: true, feedback: "Correct. Indirect cues still require immediate escalation." },
      { text: "Reassure and continue paperwork to avoid delay.", score: 6, good: false, feedback: "Reassurance without escalation is insufficient." },
      { text: "Wait for explicit threat language before action.", score: 2, good: false, feedback: "Waiting can miss critical early-risk signals." },
    ],
    categoryKey: "communication",
    recap: "Scenario recap: indirect self-harm cues require immediate policy-based escalation.",
  },
  {
    title: "Scenario 5: Duplicate High-Alert Order",
    category: "Medication Reconciliation - Immediate Hold",
    roles: ["clinical", "leadership"],
    prompt: "Transfer record shows duplicate anticoagulant with different doses. Best action?",
    choices: [
      { text: "Hold administration, verify complete med history, and escalate discrepancy to prescriber/pharmacy before dosing.", score: 18, good: true, feedback: "Correct. High-alert conflicts require immediate hold and escalation." },
      { text: "Administer lower dose now and confirm later.", score: 4, good: false, feedback: "Partial assumptions can still harm patients." },
      { text: "Continue prior unit routine without review.", score: 6, good: false, feedback: "Transfer assumptions increase medication risk." },
    ],
    categoryKey: "privacy",
    recap: "Scenario recap: high-alert medication conflicts require stop-verify-escalate behavior.",
  },
  {
    title: "Scenario 6: Allergy Reconciliation Gap",
    category: "Medication Reconciliation - Transition Risk",
    roles: ["clinical", "nonclinical", "leadership"],
    prompt: "New admission allergy list conflicts with active high-alert med plan. Best response?",
    choices: [
      { text: "Escalate reconciliation immediately, verify allergy evidence, and block administration until resolved.", score: 18, good: true, feedback: "Correct. Allergy conflicts demand immediate reconciliation." },
      { text: "Proceed with planned med and monitor closely.", score: 5, good: false, feedback: "Monitoring does not replace reconciliation before dosing." },
      { text: "Ask family to choose likely allergy history.", score: 2, good: false, feedback: "Clinical reconciliation needs formal verification workflow." },
    ],
    categoryKey: "privacy",
    recap: "Scenario recap: transition med reconciliation protects against allergy-related harm.",
  },
  {
    title: "Scenario 7: Restraint Consideration Under Stress",
    category: "Restraint Standards - Least Restrictive First",
    roles: ["clinical", "nonclinical", "leadership"],
    prompt: "A patient becomes verbally threatening; team proposes immediate restraint without alternatives. Best response?",
    choices: [
      { text: "Implement documented least-restrictive alternatives first, then escalate only if threshold criteria are met.", score: 20, good: true, feedback: "Correct. Alternatives must be attempted and documented when safe." },
      { text: "Apply restraint immediately to prevent future escalation.", score: 6, good: false, feedback: "Preemptive restraint without criteria breaches standards." },
      { text: "Do nothing and hope behavior resolves.", score: 2, good: false, feedback: "Lack of intervention planning can increase risk." },
    ],
    categoryKey: "safety",
    recap: "Scenario recap: least-restrictive interventions should be prioritized and documented before restraint.",
  },
  {
    title: "Scenario 8: Monitoring Documentation Gap",
    category: "Restraint Standards - Monitoring Compliance",
    roles: ["leadership"],
    prompt: "Audit shows missing restraint monitoring timestamps on several encounters. Best leadership action?",
    choices: [
      { text: "Initiate corrective action plan, retrain monitoring workflow, and track compliance closure with accountable owners.", score: 20, good: true, feedback: "Correct. Monitoring fidelity requires structured correction and follow-up." },
      { text: "Treat as minor paperwork issue with no follow-up.", score: 6, good: false, feedback: "Monitoring gaps are safety and legal risks." },
      { text: "Delay action until next quarter review.", score: 2, good: false, feedback: "Delayed correction leaves recurring risk unresolved." },
    ],
    categoryKey: "reporting",
    recap: "Scenario recap: monitoring documentation gaps require immediate corrective governance.",
  },
  {
    title: "Scenario 9: Interpreter Bypass at Consent",
    category: "Cultural Competence - Interpreter Use",
    roles: ["clinical", "nonclinical", "leadership"],
    prompt: "Consent discussion starts without interpreter because family says 'we can translate'. Best response?",
    choices: [
      { text: "Pause process, connect qualified interpreter, and verify comprehension using teach-back.", score: 20, good: true, feedback: "Correct. Qualified interpretation is required for informed decisions." },
      { text: "Continue with family translation for speed.", score: 6, good: false, feedback: "Unqualified interpretation can compromise informed consent." },
      { text: "Proceed without interpretation and document 'appeared to understand'.", score: 2, good: false, feedback: "Assumed comprehension is unsafe and non-compliant." },
    ],
    categoryKey: "conduct",
    recap: "Scenario recap: interpreter fidelity is central to equitable and safe care communication.",
  },
  {
    title: "Scenario 10: Culturally Misaligned Care Plan",
    category: "Cultural Competence - Respectful Care Adjustment",
    roles: ["clinical", "leadership"],
    ...
    choices: [
      { text: "Convene team review, incorporate culturally responsive adjustments, and confirm understanding through interpreter-supported communication.", score: 20, good: true, feedback: "Correct. Respectful plan adaptation improves safety and engagement." },
      { text: "Keep current plan unchanged for consistency.", score: 5, good: false, feedback: "Ignoring cultural barriers can reduce adherence and trust." },
      { text: "Refer issue to discharge planning only.", score: 4, good: false, feedback: "Delaying culturally responsive adjustment can prolong risk." },
    ],
    categoryKey: "abuseNeglect",
    recap: "Scenario recap: culturally responsive care planning requires timely, documented adjustment and communication support.",
  },
];

const lightningQuestions = [
  {
    q: "High-risk patient is missing from assigned location. First priority?",
    answers: [
      { text: "Activate elopement protocol and coordinated zone search immediately.", score: 12, good: true },
      { text: "Wait for likely return before escalating.", score: 3, good: false },
      { text: "Check one nearby hallway then resume duties.", score: 2, good: false },
    ],
    why: "Immediate search escalation reduces patient harm risk.",
    categoryKey: "reporting",
  },
  {
    q: "Observation-level handoff conflict appears. Best action?",
    answers: [
      { text: "Reconcile with read-back and document final level before transfer.", score: 12, good: true },
      { text: "Default to lower level for efficiency.", score: 2, good: false },
      { text: "Leave it for next shift to resolve.", score: 1, good: false },
    ],
    why: "Closed-loop handoffs prevent high-risk observation errors.",
    categoryKey: "communication",
  },
  {
    q: "High-alert med dose conflict detected at transfer. Correct action?",
    answers: [
      { text: "Hold med and escalate reconciliation before dosing.", score: 12, good: true },
      { text: "Give smaller dose now and confirm later.", score: 3, good: false },
      { text: "Use previous admission pattern without review.", score: 1, good: false },
    ],
    why: "High-alert reconciliation errors can cause immediate patient harm.",
    categoryKey: "privacy",
  },
  {
    q: "Family offers to interpret a consent conversation. Best response?",
    answers: [
      { text: "Use qualified interpreter and verify understanding via teach-back.", score: 12, good: true },
      { text: "Use family translation for speed.", score: 4, good: false },
      { text: "Proceed without interpretation.", score: 2, good: false },
    ],
    why: "Qualified interpreter use protects informed consent and equity.",
    categoryKey: "conduct",
  },
];

const finalAssessment = [
  { q: "When a high-risk patient is missing, first action is", a: ["Wait for likely return", "Activate elopement protocol immediately", "Document only"], c: 1, k: "reporting" },
  { q: "Elopement response quality depends on", a: ["Single-person search", "Coordinated zone search with last-seen details", "End-of-shift checks"], c: 1, k: "reporting" },
  { q: "Observation-level handoff should include", a: ["General impression", "Read-back and documented final level", "Receiving team assumptions"], c: 1, k: "communication" },
  { q: "Indirect self-harm statements should trigger", a: ["Immediate risk escalation", "Routine follow-up only", "No action until explicit threat"], c: 0, k: "communication" },
  { q: "High-alert med discrepancies require", a: ["Immediate hold and reconciliation", "Low-dose trial first", "Carry over prior unit routine"], c: 0, k: "privacy" },
  { q: "Allergy conflicts during transfer should be", a: ["Escalated before administration", "Reviewed after first dose", "Deferred to discharge"], c: 0, k: "privacy" },
  { q: "Least-restrictive care means", a: ["Try alternatives first when safe", "Use restraint as default", "Wait without intervention"], c: 0, k: "safety" },
  { q: "Restraint/seclusion requires", a: ["Time-limited criteria-based use and monitoring", "Verbal approval only", "No monitoring if calm"], c: 0, k: "safety" },
  { q: "Missing restraint monitoring timestamps are", a: ["Minor paperwork", "Safety/compliance gap needing correction", "Acceptable in busy shifts"], c: 1, k: "reporting" },
  { q: "Interpreter use for consent should be", a: ["Qualified and documented", "Family-only translation", "Optional if rushed"], c: 0, k: "conduct" },
  { q: "Teach-back during interpreted care helps confirm", a: ["Scheduling only", "Patient understanding", "Provider preference"], c: 1, k: "conduct" },
  { q: "Exit door control drift should be", a: ["Corrected immediately with follow-up", "Ignored as workflow reality", "Deferred to quarterly review"], c: 0, k: "reporting" },
  { q: "Observation ambiguity at transfer is", a: ["Acceptable temporarily", "High-risk and must be reconciled now", "For next shift to resolve"], c: 1, k: "communication" },
  { q: "Medication reconciliation documentation should be", a: ["Objective and traceable", "Memory-based", "Optional if resolved verbally"], c: 0, k: "privacy" },
  { q: "Culturally responsive planning requires", a: ["Standard script for all", "Adjustment with communication support", "Deferral to outpatient"], c: 1, k: "conduct" },
  { q: "Elopement drill readiness is measured by", a: ["Search response timing and closure", "Number of reminders", "No metrics"], c: 0, k: "reporting" },
  { q: "Observation handoff failure can cause", a: ["Minimal impact", "Major safety exposure", "Admin delay only"], c: 1, k: "safety" },
  { q: "High-alert medication process should prioritize", a: ["Speed over verification", "Verification before administration", "Prior-shift assumptions"], c: 1, k: "privacy" },
  { q: "Restraint alternatives should be", a: ["Documented when attempted", "Skipped if staffing tight", "Optional notes"], c: 0, k: "safety" },
  { q: "Interpreter substitution with minors is", a: ["Preferred", "Not appropriate for critical communication", "Fine with consent forms"], c: 1, k: "conduct" },
  { q: "Escalation events should include", a: ["Objective timeline and owners", "Narrative only", "No follow-up"], c: 0, k: "abuseNeglect" },
  { q: "If search protocol starts, communication should be", a: ["Structured and role-assigned", "Ad hoc and informal", "Limited to one person"], c: 0, k: "communication" },
  { q: "Medication transfer safety improves with", a: ["Cross-source reconciliation", "Single-source assumption", "Delayed review"], c: 0, k: "privacy" },
  { q: "Equitable care communication is strongest when", a: ["Interpreter services are timely and documented", "English-only defaults are used", "Family translates all content"], c: 0, k: "conduct" },
