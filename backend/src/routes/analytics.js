...
function inferModuleIdFromLessonTitle(title) {
  ...
  if (normalized.includes("code orange") || normalized.includes("missing patient") || normalized.includes("elopement") || normalized.includes("patient search")) return "code-orange-missing-patient-search";
